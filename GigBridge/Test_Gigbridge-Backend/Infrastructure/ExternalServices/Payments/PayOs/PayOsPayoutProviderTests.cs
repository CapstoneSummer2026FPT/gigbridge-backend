...
namespace Test_Gigbridge_Backend.Infrastructure.ExternalServices.Payments.PayOs;
...
public sealed class PayOsPayoutProviderTests
{
    ...
    {
        using var handler = DependencyInjection.CreatePayoutDirectHandler();
    ...
    {
        using var handler = DependencyInjection.CreatePayoutProxyHandler(
    ...
    public void PayoutProxyHandlerRejectsInvalidUrl()
    {
        Assert.Throws<UriFormatException>(() =>
            DependencyInjection.CreatePayoutProxyHandler("not-a-proxy-url"));
    }
