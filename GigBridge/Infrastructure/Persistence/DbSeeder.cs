    ...
    private static IReadOnlyList<SeedTableData> BuildSeedData(DateTime now) {
        return new List<SeedTableData>
        {
            ...
            new SeedTableData(
                ...
                new object?[] { "444ebc99-9c0b-4ef8-bb6d-6bb9bd380402", "Job Post Client Commitment", "JOB_POST_CLIENT_COMMITMENT", "<section><h1>Job Post E-Sign Commitment</h1><h2>{{Job.Title}}</h2><p>{{Job.Description}}</p><dl><dt>Budget</dt><dd>{{Job.Budget}}</dd><dt>Estimated duration</dt><dd>{{Job.EstimatedDuration}}</dd><dt>Location</dt><dd>{{Job.Location}}</dd><dt>End date</dt><dd>{{Job.EndDate}}</dd></dl><p>By signing, the client confirms this job post is ready to be published.</p></section>", 1, "{\"Job.Title\":\"string\",\"Job.Description\":\"string\",\"Job.Budget\":\"string\",\"Job.EstimatedDuration\":\"string\",\"Job.Location\":\"string\",\"Job.EndDate\":\"string\"}", "Client commitment template used before opening a job post", true, "a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11", now.AddDays(-29) }
                }),
